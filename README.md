...
Note: `o4_resume.py` is the old version code that use the small sample data receiveed from Lightcast, it is slightly different from `04_resume_measure.py` because of the difference of the data format between sample data and the final data received. Overall, the logic is almost the same.  
